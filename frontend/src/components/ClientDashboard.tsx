      ...
      {jobs.length === 0 ? (
        ...
        <div className="grid gap-6">
          {jobs.map((job) => {
            ...
            return (
              <Card key={job.id} className="hover:shadow-lg transition-shadow border-2 hover:border-primary/50">
                <CardHeader className="pb-3">
                ...
                <CardContent className="space-y-4">
                  ...
                  <div className="grid grid-cols-3 gap-3 p-3 bg-muted/50 rounded-lg">
                    <div className="text-center">
                      ...
                      <p className="text-lg font-bold text-primary">{proposalCount}</p>
                    </div>
                    <div className="text-center border-x">
                      <p className="text-xs text-muted-foreground mb-1">Type</p>
                      <p className="text-sm font-semibold">{job.jobType === 'HOURLY' ? 'Hourly' : 'Fixed'}</p>
                    </div>
                    <div className="text-center">
                      <p className="text-xs text-muted-foreground mb-1">Duration</p>
                      <p className="text-sm font-semibold">{job.duration || 'Flexible'}</p>
                    </div>
                  </div>
