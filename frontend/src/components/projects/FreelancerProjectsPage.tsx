...
export function FreelancerProjectsPage() {
  ...
  const fetchProjects = async () => {
    try {
      setLoading(true);
      const response = await api.get(`/api/projects/freelancer/${user?.id}`);
    ...
    <div className="min-h-screen bg-gray-50 py-8 px-4">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="flex items-center justify-between mb-8">
          ...
          <Button onClick={() => navigate('freelancer-dashboard')} variant="outline">
            Back to Dashboard
          </Button>
        </div>
          ...
          <Card>
            <CardContent className="p-12 text-center">
              ...
              <p className="text-gray-600 mb-6">
                Start by browsing jobs and submitting proposals. Projects will appear here once clients accept your bids.
              </p>
              ...
              <Card key={project.id} className="hover:shadow-lg transition-shadow">
                ...
                <CardContent className="p-6">
                  ...
                  <div className="flex gap-3 flex-wrap">
                    ...
                    <Button
                      variant="outline"
                      onClick={() => navigate('messages', { recipientId: project.client?.id })}
                    >
